...
const Header = () => {
    return (
        <div className='w-11/12 max-w-4xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <a href='/resume.pdf' download='resume.pdf' className='px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2'>my resume <Image src={assets.download_icon_white} alt='download icon' className='w-4' /></a>
            </div>
        </div>
