    ...
    <div className='fixed top=0 right=0 w-11/12 -z-10 translate-y-[-80%]'>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
            ...
            <div className="absolute top-0 right-0 max-w-screen-xl flex flex-wrap items-center justify-between  p-4 md:hidden">
                <button data-popover-target="menu" type="button" className="inline-flex items-center justify-center p-2 w-10 h-10 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-hamburger" aria-expanded={isMenuOpen ? 'true' : 'false'} onClick={toggleMenu}>
                ...
                {isMenuOpen && (
                        <div className="absolute top-10 right-10 w-[250px] text-center">
                            <ul role="menu" data-popover="menu" data-popover-placement="bottom"className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 px- text-gray-900 ">
                                <li>
                                    <a href="#top" className="block py-2 px-3  rounded-sm" >Home</a>
                                </li>
                                <li>
                                    <a href="#about" className="block py-2 px-3  rounded-sm hover:bg-gray-100">About</a>
                                </li>
                                <li>
                                    <a href="#resume" className="block py-2 px-3 rounded-sm focus:bg-red-500-gray-100 ">Resume</a>
                                </li>
                                <li>
                                    <a href="#work" className="block py-2 px-3 rounded-sm hover:bg-red-600" >Projects</a>
                                </li>
                            </ul>
                        </div>
                    )}
